            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ items[1].content }}</p><button class="btn btn-info">Xem chi tiết
                        </button>
                    </div>
                </div>
            </div>
...
const items = ([
    ...
    },
    {
        ...
        content: 'Đậu lăng, đậu nành, đậu phộng, đậu Hà Lan giàu chất xơ, protein cùng nhiều vitamin và khoáng chất, giúp giảm lượng đường trong máu, tốt cho tim…', image:
            img3
    },
]);
</script>